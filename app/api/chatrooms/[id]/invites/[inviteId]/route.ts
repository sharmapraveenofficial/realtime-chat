...
export async function DELETE(
  ...
  try {
    ...
    const inviteIdToCancel = params.inviteId;
    ...
    // Note: In this implementation, inviteId is the email address
    chatRoom.pendingInvites = chatRoom.pendingInvites.filter(
      (invite: { id: string; email: string }) => invite.id !== inviteIdToCancel
    );
